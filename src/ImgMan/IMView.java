...
public class IMView extends JFrame implements Observer {
	...
	JLabel randomLabel = new JLabel("Image information: ");
	...
	JComboBox resizeComboBox = new JComboBox(new String[] { "Don't Resize",
			"Resize Image's" });
	...
	JComboBox outputFormatComboBox = new JComboBox(new String[] { "PNG", "JPG",
			"GIF" });
	...
	public IMView(IMModel model) {
		...
		threadTxtField.setPreferredSize(new Dimension(113, 10));
		...
		gc.gridx = 0;
		gc.gridy = 0;
		leftSide.add(selectIMGFolder, gc);

		gc.gridx = 1;
		gc.gridy = 0;
		leftSide.add(inputDirectoryTxt, gc);

		gc.gridwidth = 2;
		gc.gridx = 0;
		gc.gridy = 1;
		leftSide.add(originalImage, gc);

		gc.gridwidth = 1;
		gc.gridx = 0;
		gc.gridy = 2;
		leftSide.add(processButton, gc);

		gc.gridx = 1;
		gc.gridy = 2;
		leftSide.add(maximizeButton, gc);

		gc.anchor = GridBagConstraints.LINE_START;
		gc.weighty = 1;
		gc.gridx = 0;
		gc.gridy = 3;
		leftSide.add(randomLabel, gc);
		...
		rightSide.add(brightnessLabel, gc);

		gc.gridx = 0;
		gc.gridy = 1;
		rightSide.add(brightnessSlider, gc);

		gc.gridx = 0;
		gc.gridy = 2;
		rightSide.add(hueLabel, gc);

		gc.gridx = 0;
		gc.gridy = 3;
		rightSide.add(hueSlider, gc);

		gc.gridx = 0;
		gc.gridy = 4;
		rightSide.add(saturationLabel, gc);

		gc.gridx = 0;
		gc.gridy = 5;
		rightSide.add(saturationhueSlider, gc);

		gc.gridx = 0;
		gc.gridy = 6;
		rightSide.add(contrastLabel, gc);

		gc.gridx = 0;
		gc.gridy = 7;
		rightSide.add(contrastSlider, gc);

		gc.gridx = 0;
		gc.gridy = 8;
		rightSide.add(resizeComboBox, gc);

		gc.gridx = 0;
		gc.gridy = 9;
		rightSide.add(widthLabel, gc);

		gc.gridx = 0;
		gc.gridy = 10;
		rightSide.add(widthTxtField, gc);

		gc.gridx = 0;
		gc.gridy = 11;
		rightSide.add(heightLabel, gc);

		gc.gridx = 0;
		gc.gridy = 12;
		rightSide.add(heightTxtField, gc);

		gc.gridx = 0;
		gc.gridy = 13;
		rightSide.add(outputLabel, gc);

		gc.gridx = 0;
		gc.gridy = 14;
		rightSide.add(outputFormatComboBox, gc);

		gc.gridx = 0;
		gc.gridy = 15;
		rightSide.add(threadLabel, gc);

		gc.gridx = 0;
		gc.gridy = 16;
		rightSide.add(threadTxtField, gc);

		gc = new GridBagConstraints();
		gc.anchor = GridBagConstraints.NORTHWEST;
		gc.gridx = 0;
		gc.gridy = 0;
		mainJPanel.add(leftSide, gc);

		gc = new GridBagConstraints();
		gc.anchor = GridBagConstraints.NORTHWEST;
		gc.gridx = 1;
		gc.gridy = 0;
		mainJPanel.add(rightSide, gc);
